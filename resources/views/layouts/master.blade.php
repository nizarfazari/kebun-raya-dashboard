...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('/assets/modules/select2/dist/css/select2.min.css') }}">
    <!-- General CSS Files -->
...
<body>
    ...
    <script src="{{ secure_asset('/assets/modules/select2/dist/js/select2.full.min.js') }}"></script>
